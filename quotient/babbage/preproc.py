...
class PreprocPipeline:
    """
    Multi-layer LLM-powered pre-processing pipeline for inventory extraction.
    ...
    def run_pipeline(self, text: str) -> Dict[str, str]:
        """
        Runs all pre-processing layers in sequence, returning intermediate outputs for debugging.
