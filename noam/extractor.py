...
Each item should have: 
    name (1-5 word description of the item drawn from the material description)
    part number (alphanumeric key could be a material description)
    quantity (quantity of the item)
    description (material description)
    shipping location (requested shipping location)
    client name (name of the client, frome email signature)
    clauses (alphanumeric keys that are not part numbers or material descriptions)
...
They have the format of an upper case character followed by three digits and sometimes another letter. \
